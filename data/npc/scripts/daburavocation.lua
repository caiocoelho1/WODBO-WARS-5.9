...
local items = {
          item1 = {2144, 2302}, -- item1 item que será pedido e que será dado na primeira troca
}
local counts = {
          count1 = {1000, 1}, -- count1 quantidade que será pedido e que será dado na primeira troca
}
...
function creatureSayCallback(cid, type, msg)
	...
	local talkUser = NPCHANDLER_CONVBEHAVIOR == CONVERSATION_DEFAULT and 0 or cid
		if msgcontains(msg, 'dabura vocation') then
