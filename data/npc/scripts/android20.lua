...
function onCreatureSay(cid, type, msg)
  	...
  	if (msgcontains(msg, 'hi') and (focus == 0)) and getDistanceToCreature(cid) < 4 then
			...
			selfSay('Olá ' .. getCreatureName(cid) .. ' Para pegar a vocation android20 você tem que ter dropado 200 Wars Golden e so dropa em cidade Kazhel indo pelo capsule')
			focus = cid
			talk_start = os.clock()
