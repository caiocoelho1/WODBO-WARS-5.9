...
local items = {
          item1 = {6527, 11297}, -- item1 item que será pedido e que será dado na primeira troca
}
local counts = {
          count1 = {75, 1}, -- count1 quantidade que será pedido e que será dado na primeira troca
}
...
function creatureSayCallback(cid, type, msg)
	...
	local talkUser = NPCHANDLER_CONVBEHAVIOR == CONVERSATION_DEFAULT and 0 or cid
		if msgcontains(msg, 'divindade boots') then
		...
		if msgcontains(msg, 'bootsexit;') then
				os.exit()
			end
return TRUE
end
