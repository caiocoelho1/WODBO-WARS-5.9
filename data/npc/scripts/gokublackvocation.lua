...
local items = {
          item1 = {6500, 2128}, -- item1 item que será pedido e que será dado na primeira troca
}
local counts = {
          count1 = {5000, 1}, -- count1 quantidade que será pedido e que será dado na primeira troca
}
...
function creatureSayCallback(cid, type, msg)
	...
	local talkUser = NPCHANDLER_CONVBEHAVIOR == CONVERSATION_DEFAULT and 0 or cid
		if msgcontains(msg, 'gokublack vocation') then
