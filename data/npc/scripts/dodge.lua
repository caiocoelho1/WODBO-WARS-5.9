...
function onCreatureSay(cid, type, msg)
  	...
  	if (msgcontains(msg, 'hi') and (focus == 0)) and getDistanceToCreature(cid) < 4 then
			...
			selfSay('Olá ' .. getCreatureName(cid) .. ' A cada pedra comprada você pode refinar seu skill de defense exemplo [1/100] você pode usar 100 vezes e se refinar 100 vezes ele vai ajudar muito no pvp porque defenderá de 100 hits ele tem 30% de chanse de bater 50% a menos e cada um custa 250 Wars Golden ')
			focus = cid
			talk_start = os.clock()
